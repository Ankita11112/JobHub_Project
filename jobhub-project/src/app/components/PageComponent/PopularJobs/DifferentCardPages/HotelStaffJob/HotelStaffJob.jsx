  ...
  return (
    <>
      <PageComponent>
        ...
        <GlobalJobCard1
          title={"Hotel Staff"}
          subtitle={"Hotel employees are responsible for guest satisfaction by offering services like registration, accommodation cleaning services, food service and offering response to guests to improve satisfaction. "} content={
            [
              {
                icon: tickImg,
                description:
