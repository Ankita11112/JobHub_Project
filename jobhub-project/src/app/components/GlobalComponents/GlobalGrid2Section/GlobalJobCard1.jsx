...
const Destwo = ({ content, title, subtitle, mainImage, mainImageStyle }) => {
  return (
    <>
      <Box sx={{
        my: { xs: 4, md: 10 },
      ...
      >
        ...
        <Box sx={{
          ...
          <Grid2 container sx={{
            ...
            {/* Subtitle  Section */}
            <Typography variant="h6" color="initial" sx={{ textAlign: 'center', marginTop: 1, fontSize: { xs: '13px', sm: '16px', md: '20px' } }}>
              {subtitle}
            </Typography>
            ...
            <Grid2 item xs={12} md={6} sx={{
              ...
              <Grid2 container>
                <Grid2 item xs={12} md={12} sx={{
                  ...
                  <Typography variant="h4" component="h2" sx={{ textAlign: 'center', pl: { md: '44px' }, fontWeight: 600, fontSize: { xs: '20px', md: '24px' } }}>
                    Key Responsibility:
                  </Typography>
                </Grid2>
              </Grid2>
